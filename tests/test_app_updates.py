...
def test_release_318_bundles_public_github_channel_and_valid_latest_manifest():
    ...
    assert manifest.version == "Release 3.18"
    assert manifest.download_url.endswith("/v3.18/Astra_Studio_Release_3_18.zip")
    assert manifest.notes_url.endswith("/releases/tag/v3.18")
