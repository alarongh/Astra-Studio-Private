...
def test_release_317_bundles_public_github_channel_and_valid_latest_manifest():
    ...
    assert manifest.version == "Release 3.17"
    assert manifest.download_url.endswith("/v3.17/Astra_Studio_Release_3_17.zip")
    assert manifest.notes_url.endswith("/releases/tag/v3.17")
