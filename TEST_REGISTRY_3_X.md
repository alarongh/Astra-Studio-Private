...
- `tests/test_app_updates.py::test_release_316_bundles_public_github_channel_and_valid_latest_manifest`
...
- `tests/test_release_316_editor_recovery.py::test_experimental_synthetic_input_entry_is_removed_from_ui`
