...
**Final Integration Gate status: PASSED. Release 3.3 remains the frozen functional baseline. Owner acceptance continues on Release 3.11, which includes all 3.4–3.6 repairs plus Angel 404/global-font support and the StaffedUp Java installer fix; Release 4.0 planning remains blocked until 3.x owner sign-off.**
