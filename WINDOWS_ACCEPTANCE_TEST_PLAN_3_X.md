...
Target build: **Release 3.14 — Windows verified portable build**
...
2. Use the Release 3.14 portable/source archive on Windows and extract it into a fresh normal writable folder. Do not reuse an older `.venv`.
...
- if no defects remain, the current Release 3.14 acceptance candidate receives owner sign-off while Release 3.3 remains the frozen feature baseline;
